...
export interface Database {
  public: {
    Tables: {
      ...
      meeting_participations: { Row: ParticipationRow; Insert: Omit<ParticipationRow, "id" | "created_at" | "updated_at" | "source"> & { id?: string; created_at?: string; updated_at?: string; source?: "auto" | "manual" }; Update: Partial<Database["public"]["Tables"]["meeting_participations"]["Insert"]>; Relationships: [] };
    ...
    Enums: { mentee_status: "active" | "paused" | "closed"; risk_level: "low" | "medium" | "high"; meeting_type: "individual" | "group"; meeting_front: "trafego" | "redes_sociais" | "comercial" | "estrategia"; briefing_status: "pending" | "filled"; mentor_link_source: "auto" | "manual"; participation_source: "auto" | "manual"; material_type: "recording" | "summary" };
...
export interface MenteeRow { id: string; name: string; company: string; role: string | null; joined_at: string; main_mentor_id: string | null; briefing: string; status: "active" | "paused" | "closed"; risk: "low" | "medium" | "high"; risk_reason: string; next_action: string; last_participation_at: string | null; accent: string; email: string | null; product: string | null; source_system: string; external_id: string | null; instagram_url: string | null; media_plan_url: string | null; folder_url: string | null; bonus: string | null; contract_end_at: string | null; brand_aliases: string[]; source_data: Json; created_at: string; updated_at: string }
export interface MeetingRow { id: string; google_event_id: string | null; google_calendar_id: string | null; title: string; starts_at: string; ends_at: string; meet_url: string | null; type: "individual" | "group"; front: "trafego" | "redes_sociais" | "comercial" | "estrategia"; individual_mentee_id: string | null; attendance_recorded_at: string | null; attendance_source: "auto" | "manual" | null; auto_collect_last_attempt_at: string | null; general_note: string; created_at: string; updated_at: string }
export interface ParticipationRow { id: string; meeting_id: string; mentee_id: string; attended: boolean; engagement_score: number | null; evolution_score: number | null; note: string; source: "auto" | "manual"; recorded_by: string | null; created_at: string; updated_at: string }
