...
export interface Database {
  public: {
    ...
    Enums: { mentee_status: "active" | "paused" | "closed"; risk_level: "low" | "medium" | "high"; meeting_type: "individual" | "group" };
...
export interface MeetingRow { id: string; google_event_id: string | null; google_calendar_id: string | null; title: string; starts_at: string; ends_at: string; meet_url: string | null; type: "individual" | "group"; individual_mentee_id: string | null; attendance_recorded_at: string | null; general_note: string; created_at: string; updated_at: string }
